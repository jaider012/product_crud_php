    ...
    <div class="container">
        <div style="text-align: center; margin-top: 50px;">
            ...
            <div style="display: flex; justify-content: space-around; flex-wrap: wrap; margin-top: 30px;">
                <div
                    style="width: 200px; padding: 20px; background: #fff; border-radius: 5px; box-shadow: 0 0 10px rgba(0,0,0,0.1); margin: 10px;">
                    <h3>Create</h3>
            ...
            <div style="margin-top: 40px;">
                ...
                <p><strong>Developed by:</strong> <br />Jaider Andres Panqueva Agudelo <br /> Jose David Upegui Acosta
                    <br /> Madelein Panqueva Agudelo <br /> Carlos Jeferson Castaño Bastidas
                </p>
